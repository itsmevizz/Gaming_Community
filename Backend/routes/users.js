...
router.get('/my/friends', userController.friends )
router.post('/new/personal/chat',verifyJwt, userController.personalChat)
router.get('/get/personal/chat', userController.getPersolanChat)
