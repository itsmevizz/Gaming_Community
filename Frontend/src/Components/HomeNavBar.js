...
function HomeNavBar() {
    ...
    return (
        <div>
            <div>
                <div className='flex bg-white w-full  h-[50px]  ' >
                    <div className='flex fixed-top  bg-white pt-1  shadow lg:shadow-xl justify-between w-full lg:ml-[250px] duration-200 '>
